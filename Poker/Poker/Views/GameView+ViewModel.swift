...
extension GameView {
    ...
    class GameViewModel: ObservableObject {
        ...
        @Published var players: [Player] = (0..<GameView.numberOfPlayers).map { _ in Player(isFolded: true) }
        ...
        var computerPlayers: [Player] { Array(players.prefix(GameView.numberOfPlayers - 1)) }
